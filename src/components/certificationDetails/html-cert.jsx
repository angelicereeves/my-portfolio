...
import HTMLcert from "../../assets/images/htmlcsscert.png";
    ...
    <main className="min-h-screen w-full bg-gradient-to-br from-white via-purple-100 to-purple-300 flex items-center justify-center px-6 py-6">
      <div className="w-full flex flex-col md:flex-row-reverse items-stretch">
        ...
        <div className="flex-1 flex items-center justify-center bg-purple-100 min-h-[350px] md:min-h-[500px]">
          <img
            src={HTMLcert}
            alt="HTML & CSS Fundamentals Certificate"
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-16 bg-white/90">
          <h1 className="text-4xl font-extrabold text-purple-800 mb-4">HTML & CSS Fundamentals</h1>
          <p className="text-gray-700 text-lg mb-8">
            This certificate, issued by Coding Temple in May 2025, demonstrates foundational skills in HTML and CSS. It covers topics such as semantic HTML, CSS layout techniques, responsive design, and web accessibility.
          </p>
          ...
          <div className="flex justify-center">
            <a
              href="https://www.credential.net/3d25e987-11af-464d-83b2-dc76fdeb9abb#acc.mSjqoGcg"
              target="_blank"
