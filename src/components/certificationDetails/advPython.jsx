    ...
    <main className="min-h-screen w-full bg-gradient-to-br from-white via-purple-100 to-purple-300 flex items-center justify-center px-6 py-6">
      <div className="w-full flex flex-col md:flex-row-reverse items-stretch">
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-16 bg-white/90">
          <h1 className="text-4xl font-extrabold text-purple-800 mb-4">Advanced Python</h1>
          <p className="text-gray-700 text-lg mb-8">
            This certificate, issued by Coding Temple in July 2025, demonstrates proficiency in advanced Python programming concepts. It covers topics such as data analysis, web scraping, and working with APIs.
          </p>
          ...
          <div className="flex justify-center">
            <a
              href="https://www.credential.net/5a8f1be4-e621-48d1-8a46-9af52dc818b5#acc.fAmBCEvF"
              target="_blank"
