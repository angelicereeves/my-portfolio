...
import project1Video from "../../assets/images/project1video.mp4";
    ...
    <main className="min-h-screen w-full bg-gradient-to-br from-white via-purple-100 to-purple-300 flex items-center justify-center px-6 py-6">
      <div className="w-full flex flex-col md:flex-row items-stretch">
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-16 bg-white/90">
          <h1 className="text-4xl font-extrabold text-purple-800 mb-4">Event Center Website</h1>
          <p className="text-gray-700 text-lg mb-8">
            {/* Project blurb goes here */}
            This is an Event Center Website project. It is the first project I built using HTML and CSS. I focused on creating a responsive layout and implementing a user-friendly design. The site features a homepage, event listings, a dinner menu, and a contact form. It showcases skills in front-end development and design principles.
          </p>
          ...
          <div className="flex justify-center">
            <a
              href="https://github.com/angelicereeves/module1-event-website"
              target="_blank"
