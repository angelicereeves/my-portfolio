...
import project7Video from "../../assets/images/project7video.mp4";
    ...
    <main className="min-h-screen w-full bg-gradient-to-br from-white via-purple-100 to-purple-300 flex items-center justify-center px-6 py-6">
      <div className="w-full flex flex-col md:flex-row items-stretch">
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-16 bg-white/90">
          <h1 className="text-4xl font-extrabold text-purple-800 mb-4">To Do List App</h1>
          <p className="text-gray-700 text-lg mb-8">
            {/* Project blurb goes here */}
            A simple command-line To Do List application built with Python. Users can add, view, and manage their tasks directly from the terminal, making it easy to organize and track daily activities. It provides an intuitive interface for efficient task management without the need for a graphical user interface, showcasing skills in Python.
          </p>
          ...
          <div className="flex justify-center">
            <a
              href="https://github.com/angelicereeves/intro-to-python"
              target="_blank"
