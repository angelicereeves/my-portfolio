...
import project6Video from "../../assets/images/project6video.mp4";
    ...
    <main className="min-h-screen w-full bg-gradient-to-br from-white via-purple-100 to-purple-300 flex items-center justify-center px-6 py-6">
      <div className="w-full flex flex-col md:flex-row items-stretch">
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-16 bg-white/90">
          <h1 className="text-4xl font-extrabold text-purple-800 mb-4">Quiz App</h1>
          <p className="text-gray-700 text-lg mb-8">
            {/* Project blurb goes here */}
            This is a Quiz App project. It is a simple application built using React, Javascript, and CSS. The site features a quiz functionality that allows users to answer questions of varying difficulty and topics, displaying skills in state management as well as React and styling. 
          </p>
