...
import project12Video from "../../assets/images/project12video.mp4";
    ...
    <main className="min-h-screen w-full bg-gradient-to-br from-white via-purple-100 to-purple-300 flex items-center justify-center px-6 py-6">
      <div className="w-full flex flex-col md:flex-row items-stretch">
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-16 bg-white/90">
          <h1 className="text-4xl font-extrabold text-purple-800 mb-4">Vic's Training App</h1>
          <p className="text-gray-700 text-lg mb-8">
            {/* Project blurb goes here */}
            Built for the restaurant I worked at, this app provides a virtual training environment for users to improve their skills. The app was built as a personal project using React, showcasing skills in UI design, state management, and user interaction.
          </p>
          ...
          <div className="flex justify-center">
            <a
              href="https://github.com/angelicereeves/vics-training"
              target="_blank"
