...
import project3Video from "../../assets/images/project3video.mp4";
    ...
    <main className="min-h-screen w-full bg-gradient-to-br from-white via-purple-100 to-purple-300 flex items-center justify-center px-6 py-6">
      <div className="w-full flex flex-col md:flex-row items-stretch">
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-16 bg-white/90">
          <h1 className="text-4xl font-extrabold text-purple-800 mb-4">E-commerce Website</h1>
          <p className="text-gray-700 text-lg mb-8">
            {/* Project blurb goes here */}
            This is an E-commerce Website project. It is a simple online store built using React, Javascript, and CSS. The site features a homepage with product listings, a shopping cart, and a checkout page. It showcases skills in front-end development, responsive design, and user interaction.
          </p>
          ...
          <div className="flex justify-center">
            <a
              href="https://github.com/angelicereeves/ecommerce-app"
              target="_blank"
